...
**Status:** Done (19 Aug 2026). Check-ins, remaining timeline (cap enforced from latest weight), PlanVersion history, regenerate with pins. E2E uses a stubbed signed-in `src/data` client, not a global RLS off switch.
